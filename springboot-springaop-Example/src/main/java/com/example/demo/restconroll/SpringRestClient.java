package com.example.demo.restconroll;
...
public class SpringRestClient {
	...
	private void createEmployee() {
		...
		Employee newEmployee = new Employee(1, "admin", "admin", "admin@gmail.com");
	...
	private void updateEmployee() {
		Map<String, String> params = new HashMap<String, String>();
		params.put("id", "1");
		Employee updatedEmployee = new Employee(1, "admin123", "admin123", "admin123@gmail.com");
		RestTemplate restTemplate = new RestTemplate();
